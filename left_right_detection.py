...
path2 = "C:\\Users\\Rajah\\Anaconda3\\Lib\\site-packages\\dlib\\shape_predictor_68_face_landmarks.dat"   
    ...
    while(ret):
      ...
      if len(dect) >0:
          for p, k in enumerate(dect):
              ...
              C = dist.euclidean(left_eye[0], leftEyeCenter)
		...
		# draw the connecting lines
                           ...
                           if  i == 1 and len(pts) > 10 and pts[-10] is not None:
                               dX = pts[-10][0] - pts[i][0]
                               (dirX, dirY) = ("", "")
                             #  print(dX)
                               if np.abs(dX) > 20:
...
#Points 22 to 26 is the Left Eyebrow89ooooooooooooooookicvj
